...
describe("string : method is", () => {
  ...
  it("is : false", () => {
    ...
    assert.isFalse(utilsString.is(new Date("1995-12-17T03:24:00")), "is(new Date('1995-12-17T03:24:00')) === false");
    assert.isFalse(utilsString.is(() => 1), "is(() => 1) === false");
    ...
    assert.isFalse(utilsString.is(Symbol("foo")), "is(Symbol('foo')) === false");
