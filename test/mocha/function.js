...
describe("function : method is", () => {
  ...
  it("is : false", () => {
    ...
    assert.isFalse(utilsFunction.is(new Date("1995-12-17T03:24:00")), "is(new Date('1995-12-17T03:24:00')) === false");
    ...
    assert.isFalse(utilsFunction.is(Symbol("foo")), "is(Symbol('foo')) === false");
